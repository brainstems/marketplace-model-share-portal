...
const Search = () => {
  return (
    <div className="flex flex-col justify-end gap-4  p-2 rounded-xl w-[100%] relative   ">
      <div className="w-full flex justify-between items-center relative ">
        <input
          type="text"
          className="flex h-[3.6rem] w-full items-center justify-between rounded-xl shadow-sm border-2 dark:border-[#242424] px-3 py-3 text-sm  placeholder:text-gray-500  focus:outline-none focus:ring-2  focus:dark:ring-0 focus:ring-[#41414148] bg-white dark:bg-[#202020] text-[#101010] dark:text-[#fefefe] z-[100] relative cursor-pointer placeholder:text-[1rem] text-[1rem]"
